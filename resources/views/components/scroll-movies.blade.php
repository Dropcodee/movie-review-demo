            ...
            <div class="p-4 swiper-slide">
                <div class="flex flex-col overflow-hidden rounded shadow">
                    <div class="flex-shrink-0">
                        <div class="rounded-sm shadow-md bg-gray-50">
                            <img class="object-cover w-full h-48"
                                src="https://images.unsplash.com/photo-1496128858413-b36217c2ce36?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1679&q=80"
                                alt="">
                            <div class="px-4 py-2">
                                <p class="text-xl">Movie: <span class="ml-3 text-2xl font-semibold">Movie Name
                                        Here</span>
                                </p>
                                <p class="flex justify-start my-3 space-x-1 text-xl">Rating: <span class="ml-3"><svg
